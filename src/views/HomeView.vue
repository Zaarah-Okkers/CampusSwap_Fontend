    ...
    <section class="hero full-section">
      <div class="hero-inner">
        <div class="hero-text">
          ...
          <p class="hero-desc">
            Connect directly with verified students at your institution. Safely
            trade, buy, rent books, technology, and book maintenance services.
          </p>
    ...
    <section class="core-services full-section">
      ...
      <div class="service-cards">
        <div class="service-card">
          ...
          <p>
            Buy &amp; rent textbooks, tech, and study materials from fellow
            students.
          </p>
        ...
        <div class="service-card">
          ...
          <h3>SafeHome</h3>
          <p>
            Book background-checked handymen for cleaning, repairs, and many
            more services.
          </p>
      ...
      <div class="tutorial">
        ...
        <div class="steps">
          <div class="step">
            ...
            <div class="step-body">
              ...
              <p>
                Sign up with your SA university email or work email to ensure a
                safe environment.
              </p>
            </div>
          </div>
          ...
          <div class="step">
            ...
            <div class="step-body">
              ...
              <p>
                List textbooks you no longer need, find rentals or book
                background-checked campus handymen.
              </p>
            </div>
          </div>
          ...
          <div class="step">
            ...
            <div class="step-body">
              <h3>Secure Escrow</h3>
              <p>
                Payments are held securely in escrow until you verify everything
        ...
        <div class="tutorial-actions" v-if="!isLoggedIn">
          <p class="login-prompt purple-bold">
            &#128274; Log in with your university email to access all features.
          </p>
          <button class="btn-outline-gold" @click="goToLogin">
            Log In / Register
          </button>
        </div>
      ...
      <div class="featured-inner">
        ...
        <div class="featured-grid">
          ...
          >
            ...
            <span class="item-badge">{{ product.condition_label }}</span>
          </div>
    ...
    <footer>
      <div class="footer-brand">
        ...
        <p>
          ...
          verified off-campus support services, and educational material
          exchange.
        </p>
      </div>
...
import { homeAPI, LOGOUT_MESSAGES, dashboardRoutes } from "@/services/api";
...
export default {
  ...
  async created() {
    ...
    if (stored) {
      ...
      this.user.university = u.university_name || "";
    }
  ...
  computed: {
    ...
    // who sees Checkout? students, admins, res managers (not providers)
    showCheckout() {
  ...
  methods: {
    ...
    async logout() {
      ...
      if (result.isConfirmed) {
        ...
        const message = stored ? LOGOUT_MESSAGES[stored.role] : "Logged out.";
    ...
    // actually redirect to the marketplace route
    goToAcademic() {
      this.$router.push("/academic");
    },

    // actually redirect to the SafeHome route
    goToSafeHome() {
