  ...
  <div class="home-page">
    ...
    <footer>
      ...
      <div class="footer-links">
        ...
        <ul>
          <li>
            <a href="#"> Academic Marketplace </a>
          </li>

          <li>
            <a href="#"> SafeHome Maintenance </a>
          </li>
        </ul>
      </div>
      ...
      <div class="footer-links">
        ...
        <ul>
          <li>
            <a href="#"> Ozow Escrow Guarantee </a>
          </li>

          <li>
            <a href="#"> EduID Authentication </a>
          </li>

          <li>
            <a href="#"> Safety Zones &amp; Meetups </a>
          </li>
        </ul>
      </div>
    </footer>
...
export default {
  ...
  computed: {
    ...
    showCheckout() {
      return ["student", "admin", "res_manager", "resmanager"].includes(
        this.user.role,
      );
    },
    canUseMarketplace() {
